...
try {
 ...
 if($required.Count -ne 105 -or @($required | Select-Object -Unique).Count -ne 105){throw 'Invalid independent native requirements.'}
 ...
 Write-Output 'PASS_NAVIGATOR_PRODUCT: 105 independent assertions'
} finally {
