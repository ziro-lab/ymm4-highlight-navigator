...
try {
 ...
 if($required.Count -ne 126 -or @($required | Select-Object -Unique).Count -ne 126){throw 'Invalid independent native requirements.'}
 ...
 Write-Output 'PASS_NAVIGATOR_PRODUCT: 126 independent assertions'
} finally {
