...
try {
 ...
 if($required.Count -ne 123 -or @($required | Select-Object -Unique).Count -ne 123){throw 'Invalid independent native requirements.'}
 ...
 Write-Output 'PASS_NAVIGATOR_PRODUCT: 123 independent assertions'
} finally {
