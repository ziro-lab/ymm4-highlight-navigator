...
try {
 ...
 if($required.Count -ne 47 -or @($required | Select-Object -Unique).Count -ne 47){throw 'Invalid independent native requirements.'}
 ...
 Write-Output 'PASS_NAVIGATOR_PRODUCT: 47 independent assertions'
} finally {
