...
try {
 ...
 if($required.Count -ne 69 -or @($required | Select-Object -Unique).Count -ne 69){throw 'Invalid independent native requirements.'}
 ...
 Write-Output 'PASS_NAVIGATOR_PRODUCT: 69 independent assertions'
} finally {
